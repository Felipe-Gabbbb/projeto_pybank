def exibir_metas(metas):
    print('-' * 70)
    print(f'{"Meta":<15}{"Objetivo":<15}{"Atual":<15}{"Estado":<10}')
    print('-' * 70)

    for nome, dados in metas.items():
        if dados['estado']:
            print(f'{nome:<15}R$ {dados["total"]:<12.2f}R$ {dados["valor"]:<12.2f}Ativa')
...
---------------
            ...
            if mt == '1':
                ...
                if b.upper() == 'S':
                    ...
                    for nome, dados in metas.items():
                        if not dados['estado']:
                            print(f'{nome:<15}R$ {dados["total"]:<12.2f}R$ {dados["valor"]:<12.2f}Inativa')
